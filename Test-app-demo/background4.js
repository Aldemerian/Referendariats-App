	...
	var indexTimer = 0;
	var mins = newstunde.lesson4.elemente[indexTimer].zeit;
	var seconds = mins * 60;
	var gesamtMinuten = newstunde.lesson4.elemente[indexTimer].zeit;
	var names = newstunde.lesson4.elemente[indexTimer].namen;
	var timestart = Date.now();
	console.log(timestart);
	var percent;
	var dieserTimer;
	var anzahl = newstunde.lesson4.anzahl;
	//document.getElementById("demo1").innerHTML = text;
	console.log("newstunde.lesson4.elemente.length"+newstunde.lesson4.elemente.length);
	console.log(anzahl);
	let review = { "timestamp": timestart,
					"lesson_4":[]
					};
	console.log(review);
...
function iterateLessonElement() {
	...
	nameStunde = names;
	timestamp = Date.now();
	review.lesson_4.push({"nameStunde":nameStunde, "timestamp":timestamp});
	console.log(review);
	console.log("Index "+indexTimer);
	indexTimer = indexTimer + 1;
	console.log("Index " +indexTimer);
	clearInterval(dieserTimer);
	mins = newstunde.lesson4.elemente[indexTimer].zeit;
	gesamtMinuten = newstunde.lesson4.elemente[indexTimer].zeit;
	names = newstunde.lesson4.elemente[indexTimer].namen;
	seconds = mins * 60;
	console.log(mins);
	console.log(names);
